    ...
    <footer className="relative bg-gradient-to-b from-[#0A0A0A] to-black text-white overflow-hidden pt-16 pb-8">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
            ...
            <ul className="space-y-3">
              {quickLinks.map((link, index) => (
                <motion.li 
                  ...
                  transition={{ type: "spring", stiffness: 400, damping: 10 }}
                >
                  <a href={link.url} className="text-gray-300 hover:text-[#D4AF37] transition-colors duration-300">
                    {link.name}
                  </a>
                </motion.li>
              ))}
          ...
          {/* Recent Results */}
          <motion.div variants={itemVariants} className="flex flex-col items-center md:items-start">
            <h3 className="text-xl font-bold mb-6 text-[#D4AF37] border-b border-[#D4AF37] pb-2">Recent Results</h3>
