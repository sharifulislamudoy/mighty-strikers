...
const Footer = () => {
    ...
    const matchResults = [
        { vs: 'Thunder Bolts', result: 'Won by 42 runs', date: '15 Oct 2023' },
        { vs: 'Royal Challengers', result: 'Won by 5 wickets', date: '22 Oct 2023' },
        { vs: 'Super Kings', result: 'Lost by 12 runs', date: '29 Oct 2023' },
    ];
            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                ...
                >
                    ...
                    <motion.div variants={itemVariants} className="flex flex-col">
                        <h3 className="text-xl font-bold mb-6 text-[#D4AF37] border-b border-[#D4AF37] pb-2">Quick Links</h3>
                    ...
                    {/* Recent Results */}
                    <motion.div variants={itemVariants} className="flex flex-col items-center md:items-start">
                        <h3 className="text-xl font-bold mb-6 text-[#D4AF37] border-b border-[#D4AF37] pb-2 w-full text-center md:text-left">Recent Results</h3>
                        <div className="space-y-4 w-full">
                            {matchResults.map((match, index) => (
                                <motion.div
                                    key={index}
                                    className="bg-[#1a1a1a] p-3 rounded-lg border-l-4 border-[#D4AF37]"
                                    whileHover={{ scale: 1.02 }}
                                    transition={{ type: "spring", stiffness: 400, damping: 10 }}
                                >
                                    <div className="flex justify-between items-start">
                                        <div className="text-center md:text-left">
                                            <h4 className="font-semibold">VS {match.vs}</h4>
                                            <p className={`text-sm ${match.result.includes('Won') ? 'text-green-400' : 'text-red-400'}`}>
                                                {match.result}
                                            </p>
                                        </div>
                                        <span className="text-xs text-gray-400 hidden md:block">{match.date}</span>
                                    </div>
